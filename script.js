...
function submitSurvey() {
  saveAnswers();
  console.log("Data dikirim (simulasi):", answers);

  // Simulasi POST: ubah answers jadi blob dan download sebagai file
  ...
  // Loading spinner lalu redirect ke halaman terima kasih
